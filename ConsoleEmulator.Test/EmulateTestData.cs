...
internal class EmulateTestData
{
    ...
    {
        yield return new object[] { new byte[1] { 0x09 }, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x06, 0x08, 0x01, 0x00 };
        yield return new object[] { new byte[1] { 0x19 }, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x08, 0x0A, 0x01, 0x00 };
        yield return new object[] { new byte[1] { 0x29 }, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x0A, 0x0C, 0x01, 0x00 };
        yield return new object[] { new byte[1] { 0x39 }, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x0C, 0x0E, 0x01, 0x00 };
        yield return new object[] { new byte[1] { 0x09 }, 0x00, 0x01, 0x00, 0x01, 0xFF, 0xFF, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
        yield return new object[] { new byte[1] { 0x19 }, 0x00, 0x01, 0x00, 0x01, 0xFF, 0xFF, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
        yield return new object[] { new byte[1] { 0x29 }, 0x00, 0x01, 0x00, 0x01, 0xFF, 0xFF, 0x00, 0x01, 0xFF, 0xFE, 0x00, 0x01 };
        yield return new object[] { new byte[1] { 0x39 }, 0x00, 0x01, 0x00, 0x01, 0xFF, 0xFF, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 };
    }
}
